...
export default function Page() {
  ...
  return <main className="site-shell">
    <header className="topbar"><a className="brand" href="#top">TEDx<span>IGDTU</span></a><nav><a href="#why">Why TEDx?</a><a href="#process">Process</a><button className={view === 'apply' ? 'active' : ''} onClick={() => setView('apply')}>Apply</button><button className={view === 'admin' ? 'active' : ''} onClick={() => setView('admin')}>Admin</button></nav></header>
    {view === 'apply' ? <>
      ...
      <section className="why-section" id="why"><p className="eyebrow">WHY TEDxIGDTU?</p><h2>Ideas don’t spread<br />themselves. <em>People do.</em></h2><div className="why-grid"><div><span>01</span><h3>Find your people</h3><p>Work with curious minds from every corner of campus.</p></div><div><span>02</span><h3>Build something real</h3><p>From a blank page to a room full of listeners.</p></div><div><span>03</span><h3>Leave a mark</h3><p>Help create a stage that makes the world a little bigger.</p></div></div></section>
